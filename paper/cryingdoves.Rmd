...
app <- ts(doves_kor$approval, doves_kor$quarter)
...
```{r plot2, fig.width = 7, fig.height = 4, warning = FALSE, message = FALSE, echo = FALSE, fig.cap="\\label{fig:plot2}Net Cooperation Scores"}

gold_kj <- ts(doves_kor$kj_q, doves_kor$quarter)
gold_kc <- ts(doves_kor$kc_q, doves_kor$quarter)
gold_kp <- ts(doves_kor$kp_q, doves_kor$quarter)
...
```{r VAR, fig.width = 7, fig.height = 4, warning = FALSE, message = FALSE, echo = FALSE, fig.cap="\\label{fig:plot2}IRFs"}
VAR_data <- window(ts.union(app, gold_kj, gold_kc, gold_kp))

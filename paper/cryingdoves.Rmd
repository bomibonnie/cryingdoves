...
setwd("C:/Users/bomim/Documents/cryingdoves")
...
```{r VAR, fig.width = 4, fig.height = 4, warning = FALSE, message = FALSE, echo = FALSE, fig.cap="\\label{fig:plot2}IRFs"}
...
```{r ADLplot, fig.width = 7, fig.height = 6, warning = FALSE, message = FALSE, echo = FALSE, fig.cap="\\label{fig:plot5}Net Cooperation Scores"}
...
```{r fig.width = 7, fig.height = 6, warning = FALSE, message = FALSE, echo = FALSE, fig.cap="\\label{fig:plot6}Net Cooperation Scores"}
